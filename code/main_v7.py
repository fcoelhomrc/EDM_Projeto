...
def do_connect():
    ...
    '''
    essid = "Galaxy A32 5G1A70" #"MEO-F770C0" # "NOS-D610"
    password = "yfee4537" #"7cdd0a29c1" # "fbe228d0bc19"
...
red_led = PWM(Pin(22, Pin.OUT), freq=1000, duty=1023)
green_led = PWM(Pin(21, Pin.OUT), freq=1000, duty=1023)
blue_led = PWM(Pin(18, Pin.OUT), freq=1000, duty=1023)
...
async def loop():
    ...
    global client
    global LED_ENABLED, VERBOSE, CONNECTED
    ...
    while True:
        ...
        # Activate LED
            ...
            # Balance out the different maximum luminosities
            DR *= (8/65); DB *= (12/65)
            # Control pins for RGB LED
            if LED_ENABLED:
                # LED is active low
                red_led.duty(int(1023-DR))
                green_led.duty(int(1023-DG))
                blue_led.duty(int(1023-DB))
            ################################################################################
